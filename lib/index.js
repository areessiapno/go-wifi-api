...
module.exports = class GoWifiAPI {
    /**
     * GoWifiAPI
     * Creates the instance of the `GoWifiAPI` class.
     *
     * @name GoWifiAPI
     * @function
     * @param {Object} options An object containing:
     *
     *  - `partnerId` (String): GoWifi API partnerId credentials (mandatory). 
     *  - `host` (String): GoWifi  API host (Optional default: `https://re-arch-staging.mygowifi.com:8119/api/callback/provision`).
    ...
    constructor (options) {
        ...
        this.host = options.host || "https://re-arch-staging.mygowifi.com:8119/api/callback/provision";
    ...
    /**
     * payload
     * Send Provision message request to GoWifiAPI
     *
     * @name payload
     * @function
